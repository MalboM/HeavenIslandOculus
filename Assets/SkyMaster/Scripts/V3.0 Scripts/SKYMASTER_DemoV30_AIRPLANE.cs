			...
			if (SUNMASTER.currentWeather != null && SUNMASTER.currentWeather.VolumeCloud != null) {
				...
				if (GUI.Button(new Rect(7*(BOX_WIDTH+XOffset)+30, 0, BOX_WIDTH+60, 22), "Cycle cloud materials"+"("+ (cloud_mat_counter+1).ToString() +")")){
					if(cloud_mat_counter == 0){
						SUNMASTER.currentWeather.VolumeCloud.GetComponent<ParticleRenderer>().material = CloudMat1;
						SUNMASTER.currentWeather.VolumeScript.ScatterMat = SUNMASTER.currentWeather.VolumeCloud.GetComponent<ParticleRenderer>().material;

					}else if(cloud_mat_counter == 1){
						SUNMASTER.currentWeather.VolumeCloud.GetComponent<ParticleRenderer>().material = CloudMat2;
						SUNMASTER.currentWeather.VolumeScript.ScatterMat = SUNMASTER.currentWeather.VolumeCloud.GetComponent<ParticleRenderer>().material;
					}else if(cloud_mat_counter == 2){
						SUNMASTER.currentWeather.VolumeCloud.GetComponent<ParticleRenderer>().material = CloudMat3;
						SUNMASTER.currentWeather.VolumeScript.ScatterMat = SUNMASTER.currentWeather.VolumeCloud.GetComponent<ParticleRenderer>().material;
					}else if(cloud_mat_counter == 3){
						SUNMASTER.currentWeather.VolumeCloud.GetComponent<ParticleRenderer>().material = CloudMat4;
						SUNMASTER.currentWeather.VolumeScript.ScatterMat = SUNMASTER.currentWeather.VolumeCloud.GetComponent<ParticleRenderer>().material;
					}
					cloud_mat_counter++;
				}
