...
Shader "SkyMaster/ScatterShadedCloudMOTION Soft" {
	Properties {
...
//    			
		...
		float4 return1 = tex2D (_MainTex,IN.texcoord.xy )* tex2D(_BorderTex, IN.uv.xy+float2(_Time.x*_Speed.x,_Time.x*_Speed.y)) * IN.color * _Intensity;
