...
// Disable ability to set second context at this time
...
*/
			// 0.11 - far falloff used to add reflection gain to authored curves (Fixed mode)
			Label("Reflection Gain (Range: 0 - 1000000 meters)");
			GUI.color = Color.white;
			m_Component.FalloffFar   = EditorGUILayout.FloatField("", m_Component.FalloffFar);
