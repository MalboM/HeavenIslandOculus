...
public class OSPAudioSource : MonoBehaviour 
{
	...
	[SerializeField]
	private OSP_Priority priority = OSP_Priority.PRI_5;
	public OSP_Priority Priority
	{
		get{return priority;}
		set{priority = value;
			if(priority < OSP_Priority.PRI_Highest) priority = OSP_Priority.PRI_Highest;
			if(priority > OSP_Priority.PRI_Lowest) priority = OSP_Priority.PRI_Lowest;
		}
	}
